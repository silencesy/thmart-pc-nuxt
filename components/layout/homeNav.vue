<template>
    <div class="nav">
        <div class="container">
            <div class="homeHead">
                <div class="left"><nuxt-link :to="{path: '/'}"><img src="~static/images/thmart.png" alt=""></nuxt-link></div>
                <div class="center">
            ...
            <div class="homeNav">
                <ul>
                    ...
                    <li>
                        <nuxt-link :class="{theme_color: $route.fullPath == '/category/item?one=1'}" :to="{name: 'category-item',query: {one: 1}}">Ticketing</nuxt-link>
                    </li>
<!--                     <li>
